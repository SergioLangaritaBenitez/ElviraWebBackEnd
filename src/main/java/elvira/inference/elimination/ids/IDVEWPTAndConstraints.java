...
/**
 * Class <code>VEWPTAndCOnstraints</code>.
 * Implements the variable elimination method of propagation using
 * potentials of class <code>PotentialTree</code>. If the initial 
 * potentials are not PotentialTrees then they are converted to 
 * PotentialTrees. This class uses the constraints to improve the
 * evaluation of the influence diagram
 *
 * @since 27/06/2002
 */
