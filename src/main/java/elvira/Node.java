...
public ArrayList<String> getAllParents2(){
	...
	//Todos estos nodos son a�adidos en la posicion 0
  ...
  // Repetimos hasta que ningun nodo sea a�adido
  ...
  while(inserted) {
    ...
    if (previousSet.size() != 0) {
        ...
        // A�adir un nuevo elemento a visitar
