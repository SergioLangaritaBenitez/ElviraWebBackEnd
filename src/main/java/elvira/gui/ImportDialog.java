    ...
    public ImportDialog(Frame frame, String title, boolean modal) {
        ...
        switch (Elvira.getLanguaje()) {
            case Elvira.AMERICAN:
                menusBundle = ResourceBundle.getBundle("localize/Menus");
                dialogBundle =ResourceBundle.getBundle("localize/Dialogs");
                messagesBundle =ResourceBundle.getBundle("localize/Messages");
                break;
            case Elvira.SPANISH:
                menusBundle =ResourceBundle.getBundle("localize/Menus_sp");
                dialogBundle =ResourceBundle.getBundle("localize/Dialogs_sp");
                messagesBundle =ResourceBundle.getBundle("localize/Messages_sp");
                break;
        } // End of switch
