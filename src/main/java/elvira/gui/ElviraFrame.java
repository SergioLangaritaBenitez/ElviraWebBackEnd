...
public class ElviraFrame extends JFrame implements ClipboardOwner {
    ...
    zoomOutIcon, linkIcon, influenceLinkIcon, layoutIcon, chanceNodeIcon, observedNodeIcon, continuousNodeIcon,
  ...
  private JMenuItem newItem, openItem, openDBCItem, importItem, exportItem,
    ...
    private JCheckBoxMenuItem selectItem, chanceItem,observedItem,continuousItem,
  ...
  private JMenuItem propagationMethodItem, generateDBCItem,
    ...
    public ElviraFrame() {
      ...
      case Elvira.AMERICAN:
        menuBundle = ResourceBundle.getBundle("localize/Menus");
            dialogBundle = ResourceBundle.getBundle("localize/Dialogs");
            break;
      case Elvira.SPANISH:
        menuBundle = ResourceBundle.getBundle("localize/Menus_sp");
            dialogBundle = ResourceBundle.getBundle("localize/Dialogs_sp");
            break;
        }
        ...
        observedNodeIcon = new ImageIcon(Elvira.class.getResource(imagesPath+"doubleoval.jpg"));
        ...
        insertButton(observedNodeButton, observedNodeIcon, editionToolbar, "Edit.Observed");
        editionButtonGroup.add(observedNodeButton);
        observedNodeButton.setMargin(new Insets(1,1,1,1));
     ...
     */
        ...
        observedItem = insertCheckBoxMenuItem(observedNodeIcon, editMenu,
                "Edit.Select", "Add Observed Node");
                observedItem.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, Event.SHIFT_MASK));
                modifyGroup.add(observedItem);
    ...
    private void addObservedNodeAction(ActionEvent event) {
		// TODO Auto-generated method stub
		   currentNetworkFrame.getEditorPanel().setMode(EditorPanel.CREATE_NODE);
	        currentNetworkFrame.getEditorPanel().setNodeType(Node.OBSERVED);
	        observedNodeButton.setSelected(true);
	        //chanceItem.setSelected(true);
	        Network bayelvira = currentNetworkFrame.getEditorPanel().getBayesNet();
	        bayelvira.setDefaultChanceNode(Node.FINITE_STATES);
	}
   ...
   /* The next functions are mainly used by the methods implement
    ...
    ParseException, IOException{
        ...
        Network netToLoad;
         ...
         try {
            ...
            // a las caracter�sticas visuales de los nodos
    ...
    public class ElviraAction implements ActionListener {
        public void actionPerformed(java.awt.event.ActionEvent event) {
            ...
            else if (object == observedNodeButton)
            	addObservedNodeAction(event);
     ...
     *
     * A�adido por Jorge-PFC el 05/12/2005
     *
    ...
    * A�adido por Jorge-PFC el 05/12/2005
     ...
     * mediator creado pueda acceder a este atributo
     *
     * A�adido por Jorge-PFC el 06/12/2005
     *
     ...
     * mediator creado pueda acceder a esta toolbar y a�ada el
     ...
     * mediator creado pueda acceder a este atributo
     *
     * A�adido por Jorge-PFC el 08/12/2005
     *
     ...
     * mediator creado pueda acceder a este atributo
     *
     * A�adido por Jorge-PFC el 27/12/2005
     *
