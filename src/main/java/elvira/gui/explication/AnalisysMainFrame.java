...
public class AnalisysMainFrame extends JDialog {
	...
	private boolean seleccion=false;//Selecci�n de tipo de analisis
	...
	public AnalisysMainFrame(NetworkFrame frame) {
		...
		switch (Elvira.getLanguaje()) {
		   case Elvira.AMERICAN: analisysBundle = ResourceBundle.getBundle ("localize/SensitivityAnalisys");            
			                         break;
		   case Elvira.SPANISH:  analisysBundle = ResourceBundle.getBundle ("localize/SensitivityAnalisys_sp");   
			                         break;		                         
		}		
...
/*NO-->*/	Start_Analisis start= new Start_Analisis(frame);
	...
	private void initialize(NetworkFrame frame) {
		...
		JOptionPane.showMessageDialog(frame2,
                "Ning�n caso almacenado \n"+"Se va a crear un nuevo caso de estudio para el An�lisis de Sensibilidad",
                "N�mero de casos de estudio =0",
                JOptionPane.INFORMATION_MESSAGE);
		}
		this.setVisible(true);
	}
 
	// 2� metodo para inicializar 
	...
	private void initialize2(NetworkFrame frame){
		...
		if(casesl.getNumCurrentCase()==0){
			JOptionPane.showMessageDialog(frame2,
	                "An�lisis sin Evidencia\n"+"No se registrar�n casos de estudio para el An�lisis de Sensibilidad",
	                "N�mero de casos de estudio =0",
	                JOptionPane.INFORMATION_MESSAGE);
			}
	...
	private JButton getJButton1() {
		if (jButton1 == null) {
			...
			jButton1.setIcon(new ImageIcon("C:/Documents and Settings/Alberto/Mis documentos/Mis im�genes/grafico2.JPG"));
...
//					Evidencia seleccionada desde la red directamente
						if(evidencia2.isShowing()){
							...
							//Hallazgos que se introducen en el An�lisis y 
		...
		}// fin del IF del componente Bot�n
		return jButton2;
	}
	...
	private JButton getJButton5() {
		if (jButton5 == null) {
			jButton5 = new JButton(Elvira.localize(analisysBundle,"NewAnalisys"),new ImageIcon("C:/Documents and Settings/Alberto/Mis documentos/Mis im�genes/icono2.JPG"));
...
//	Metodo para rellenar el JComboBox1
	private void fill_Jcombo1() throws Throwable{
		...
		}else{//NIVEL 2 -->Creaci�n del Conjunto Sensible
...
public void fill_JTableParametro(Node nodoactual){
	...
	//Para visualizar las caracter�sticas de la Tabla
...
//par�metros en estudio no se editable ya que "DefaultTableModel"
	...
	if (jButton4 == null) {
		...
		jButton4.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				jButton4.setEnabled(false);
				IncrementBar();
//				2� Paso para introducir numero binario
