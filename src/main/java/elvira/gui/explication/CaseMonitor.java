...
public class CaseMonitor extends javax.swing.JDialog{
	...
	int languaje = Elvira.getLanguaje();
   	...
   	switch (languaje) {
		   case Elvira.AMERICAN: explanationBundle = ResourceBundle.getBundle ("localize/Explanation");            		                         
		                         break;
		   case Elvira.SPANISH: explanationBundle = ResourceBundle.getBundle ("localize/Explanation_sp");   		                        
		                        break;		                         
		}				
		setModal(true);
		setResizable(false);		
...
//	   System.out.println("Caso activo "+CL.getNumActiveCase()+" Caso actual"+CL.getNumCurrentCase());
	...
	{
	    //si el caso activo=anterior a �l, quiere decir que todav�a no se ha a�adido evidencia
	    //a dicho caso, lo que es equivalente a que est� "vac�o". Por tanto, en esta situaci�n,
	    //al pulsar a a�adir caso, saldr� un mensaje y no se a�adir� uno nuevo.
