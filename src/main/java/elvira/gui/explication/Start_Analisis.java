...
public class Start_Analisis extends JDialog {
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			imagen1.setIcon(new ImageIcon(getClass().getResource("/images/escudo.jpg")));
			...
			pregunta.setText("�C�mo desea realizar el an�lisis?");
	...
	private JButton getBotoncon() {
		if (botoncon == null) {
			...
			botoncon.setIcon(new ImageIcon(getClass().getResource("/images/inicial.JPG")));
	...
	private JButton getBotonsin() {
		if (botonsin == null) {
			...
			botonsin.setIcon(new ImageIcon(getClass().getResource("/images/inicial.JPG")));
	...
	private JButton getBotonsalir() {
		if (botonsalir == null) {
			...
			botonsalir.setIcon(new ImageIcon(getClass().getResource("/images/UCLM.jpg")));
