...
public class ChoiceEvidence extends JDialog  {
	...
	//2� Constructor para la Evidencia seleccionda desde la red Inicial
	...
	private JPanel getJPanel() {
		if (jPanel == null) {
			...
			jPanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED), BorderFactory.createTitledBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED), "A�adir", TitledBorder.CENTER, TitledBorder.DEFAULT_POSITION, new Font("Consolas", Font.PLAIN, 14), SystemColor.inactiveCaption)));
