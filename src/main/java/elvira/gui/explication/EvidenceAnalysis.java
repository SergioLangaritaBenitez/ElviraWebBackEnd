...
public class EvidenceAnalysis extends javax.swing.JDialog {
    ...
    public EvidenceAnalysis(Bnet b, Case ce, Evidence e, Node n) {
        switch (Elvira.getLanguaje()) {
		   case Elvira.AMERICAN: dialogBundle = ResourceBundle.getBundle ("localize/Explanation");
		                         break;
		   case Elvira.SPANISH: dialogBundle = ResourceBundle.getBundle ("localize/Explanation_sp");
		                        break;
		}
        bnet=b;
        currentcase=ce;
