...
public class ShowMessages {
   ...
   static {
		switch (Elvira.getLanguaje()) {
		   case Elvira.AMERICAN: messagesBundle = ResourceBundle.getBundle ("localize/Messages");
		                         break;
		   case Elvira.SPANISH: messagesBundle = ResourceBundle.getBundle ("localize/Messages_sp");
		                        break;
		}
   }
