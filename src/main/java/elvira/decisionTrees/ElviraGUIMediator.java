...
/**
 * Intenta minimizar el n� de cambios en el ElviraFrame delegando las nuevas acciones a esta clase
 * 
...
public class ElviraGUIMediator implements ActionListener, ChangeListener {
    /* A�adido por Jorge-PFC el 28/11/2005 */
    /**
     * 
     */
    private JToolBar decisionTreeToolbar= decisionTreeToolbar= new JToolBar();

    /* A�adido por Jorge-PFC el 26/12/2005 */
    ...
    /* A�adido por Jorge-PFC el 01/12/2005 */
    /**
     * 
     */
	...
	public void addDecisionTreeToolbar(JPanel toolbarPanel) {
        ...
        // Se a�ade al panel de herramientas de Elvira
        toolbarPanel.add(decisionTreeToolbar,BorderLayout.WEST);
        
        // A�adido por Jorge-PFC el 28/11/2005
        // DONE: A�adir al bundle la etiqueta
        ...
        // A�adido por Jorge-PFC el 28/11/2005
        // DONE: A�adir al bundle la expansion inicial del arbol a mostrar
        // DONE: Nivel m�ximo de expansion debe cambiarse al cambiar a la vista del arbol de decision
        ...
        // DONE: �Una manera menos liosa de darle un tama�o minimo al spinner?
	...
	/**
	 * Control de n� de arbol de decision creado para un mismo DI
	 */
     ...
     * @param event
     * 
     * DONE: �porque al pulsar este boton a partir de la 2� para un mismo DI, no sale el AD expandido
     * hasta el nivel predeterminado? Se deb�a a que se duplicaba el nombre de la nueva ventana
     */
    public void dectreeAction(ActionEvent event) {
    	...
    	if( bnet instanceof IDWithSVNodes) {
    		...
    		// DONE: a�adir un numeral para evitar duplicados
    		int version=1;
     ...
     * @param event
     * 
     * A�adido por Jorge-PFC el 04/12/2005 
     */
	...
	public void actionPerformed(ActionEvent event) {
		...
		if( cmd.equals("Create Decision Tree") ) {
        	...
        	// A�adido por Jorge-PFC 04/12/2005
	...
	public void setupBundle() {
        switch (Elvira.getLanguaje()) {
        	case Elvira.AMERICAN:
        		decisionTreesBundle= ResourceBundle.getBundle("localize/DecisionTrees");
        		break;
        	case Elvira.SPANISH:
        		decisionTreesBundle= ResourceBundle.getBundle("localize/DecisionTrees_sp");
        		break;
        }
	}
